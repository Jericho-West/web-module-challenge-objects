...
console.log(createMenuItem("eggnog", 1, "Drink"))
console.log(createMenuItem("toast", 2, "Breakfast"))
...
function addReview(existingArray){
  let newArray = {name: 'Daniela', rating: 5, feedback: "great eats!"}
